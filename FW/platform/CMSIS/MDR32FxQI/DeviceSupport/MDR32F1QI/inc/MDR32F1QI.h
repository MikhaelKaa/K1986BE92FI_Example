...
#ifndef __MDR32F1QI_H
#define __MDR32F1QI_H
...
/** @addtogroup MDR32F1QI_Peripheral MDR32F1QI Peripheral
  * @{
  */
...
/**
  * @brief MDR32F1QI Interrupt Number Definition
  */
...
#define __CM1_REV              0x0102   /*!< Core Revision                                */
...
/** @defgroup __MDR32F1QI_Periph_CAN_CONTROL	CAN CONTROL
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_CAN_STATUS	CAN STATUS
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_CAN_BITTMNG	CAN BITTMNG
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_CAN_INT_EN	CAN INT EN
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_CAN_RXID	CAN RXID
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_CAN_RXDLC	CAN RXDLC
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_CAN_RXDATAL	CAN RXDATAL
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_CAN_RXDATAH	CAN RXDATAH
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_CAN_BUF_CON	CAN BUF CON
  * @{
  */ 
...
/** @} */ /* End of group __MDR32F1QI_Periph_CAN_Defines Defines */
...
/** @defgroup __MDR32F1QI_Periph_USB_HTXC	USB HTXC
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_USB_HTXLC	USB HTXLC
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_USB_HIS	USB HIS
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_USB_HIM	USB HIM
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_USB_HRXS	USB HRXS
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_USB_SEP_CTRL	USB SEP CTRL
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_USB_SEP_STS	USB SEP STS
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_USB_SC	USB SC
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_USB_SIS	USB SIS
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_USB_SIM	USB SIM
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_USB_HSCR	USB HSCR
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_USB_HSVR	USB HSVR
  * @{
  */ 
...
/** @} */ /* End of group __MDR32F1QI_Periph_USB_Defines */
...
/** @defgroup __MDR32F1QI_Periph_EEPROM_CMD	EEPROM CMD
  * @{
  */ 
...
/** @} */ /* End of group __MDR32F1QI_Periph_EEPROM_Defines Defines */
...
/** @defgroup __MDR32F1QI_Periph_RST_CLK_Data_Structures Data Structures
  * @{
  */
...
/** @defgroup __MDR32F1QI_Periph_RST_CLK_Defines Defines
  * @{
  */

/** @defgroup __MDR32F1QI_Periph_RST_CLK_CLOCK_STATUS	RST CLK CLOCK STATUS
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_RST_CLK_PLL_CONTROL	RST CLK PLL CONTROL
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_RST_CLK_HS_CONTROL	RST CLK HS CONTROL
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_RST_CLK_CPU_CLOCK RST CLK CPU CLOCK
  * @{
  */
...
/** @defgroup __MDR32F1QI_Periph_RST_CLK_USB_CLOCK	RST CLK USB CLOCK
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_RST_CLK_ADC_MCO_CLOCK	RST CLK ADC MCO CLOCK
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_RST_CLK_RTC_CLOCK	RST CLK RTC CLOCK
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_RST_CLK_TIM_CLOCK	RST CLK TIM CLOCK
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_RST_CLK_UART_CLOCK	RST CLK UART CLOCK
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_RST_CLK_SSP_CLOCK	RST CLK SSP CLOCK
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_RST_CLK_ETH_CLOCK	RST CLK ETR CLOCK
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_DMA_STATUS	DMA STATUS
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_DMA_CFG	DMA CFG
  * @{
  */ 
...
/** @} */ /* End of group __MDR32F1QI_Periph_DMA_Defines */
...
/** @defgroup __MDR32F1QI_Periph_UART_Data_Structures Data Structures
  * @{
  */

/** @defgroup __MDR32F1QI_Periph_UART_TypeDef UART_TypeDef
  * @{
  */
...
/** @defgroup __MDR32F1QI_Periph_UART_Defines Defines
  * @{
  */

/** @defgroup __MDR32F1QI_Periph_UART_DR	UART DR
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_UART_RSR_ECR	UART RSR ECR
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_UART_FR	UART FR
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_UART_LCR_H	UART LCR H
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_UART_CR	UART CR
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_UART_IFLS	UART IFLS
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_UART_IMSC	UART IMSC
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_UART_RIS	UART RIS
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_UART_MIS	UART MIS
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_UART_ICR	UART ICR
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_UART_DMACR	UART DMACR
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_UART_RTTCR	UART RTTCR
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_SPI_Data_Structures Data Structures
  * @{
  */

/** @defgroup __MDR32F1QI_Periph_SPI_TypeDef SPI_TypeDef
  * @{
  */
...
/** @defgroup __MDR32F1QI_Periph_SPI_Defines Defines
  * @{
  */

/** @defgroup __MDR32F1QI_Periph_SSP_CR0	SSP CR0
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_SSP_CR1	SSP CR1
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_SSP_SR	SSP SR
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_SSP_IMSC	SSP IMSC
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_SSP_RIS	SSP RIS
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_SSP_MIS	SSP MIS
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_SPI_SSPx SPI SSPx
 *  @{
 */
...
/** @defgroup __MDR32F1QI_Periph_SSP_ICR	SSP ICR
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_SSP_DMACR	SSP DMACR
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_MIL_STD_1553_Data_Structures Data Structures
  * @{
  */
...
/** @defgroup __MDR32F1QI_Periph_MIL_STD_1553_Defines Defines
  * @{
  */
/** @defgroup __MDR32F1QI_Periph_MIL_STD_1553_CONTROL	MIL STD 1553 CONTROL
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_MIL_STD_1553_STATUS	MIL STD 1553 STATUS
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_MIL_STD_1553_ERROR	MIL STD 1553 ERROR
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_MIL_STD_1553_ITEEN	MIL STD 1553 ITEEN
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_POWER_PVDCS	POWER PVDCS
  * @{
  */ 
...
/** @} */ /* End of group __MDR32F1QI_Periph_POWER_Defines */
...
/** @defgroup __MDR32F1QI_Periph_WWDG_CR	WWDG CR
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_WWDG_CFR	WWDG CFR
  * @{
  */ 
...
/** @} */ /* End of group __MDR32F1QI_Periph_WWDG_Defines */
...
/** @defgroup __MDR32F1QI_Periph_IWDG_SR	IWDG SR
  * @{
  */ 
...
/** @} */ /* End of group __MDR32F1QI_Periph_IWDG_Defines */
...
/** @defgroup __MDR32F1QI_Periph_TIMER_Data_Structures Data Structures
  * @{
  */

/** @defgroup __MDR32F1QI_Periph_TIMER_TypeDef TIMER_TypeDef
  * @{
  */
...
/** @defgroup __MDR32F1QI_Periph_TIMER_Defines Defines
  * @{
  */

/** @defgroup __MDR32F1QI_Periph_TIMER_CNTRL	TIMER CNTRL
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_TIMER_CH_CNTRL	TIMER CH CNTRL
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_TIMER_CH_CNTRL1 TIMER CH CNTRL1
  * @{
  */
...
/** @defgroup __MDR32F1QI_Periph_TIMER_CH_DTG	TIMER CH DTG
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_TIMER_BRKETR_CNTRL	TIMER BRKETR CNTRL
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_TIMER_STATUS	TIMER STATUS
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_TIMER_IE	TIMER IE
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_TIMER_DMA_RE	TIMER DMA RE
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_TIMER_CH_CNTRL2	TIMER CH CNTRL2
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_ADC_Data_Structures Data Structures
  * @{
  */

/** @defgroup __MDR32F1QI_Periph_ADC_TypeDef ADC_TypeDef
  * @{
  */
...
/** @defgroup __MDR32F1QI_Periph_ADC_Defines Defines
  * @{
  */

/** @defgroup __MDR32F1QI_Periph_ADC1_CFG	ADC1 CFG
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_ADC2_CFG	ADC2 CFG
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_ADC1_RESULT	ADC1 RESULT
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_ADC_STASUS	ADC STASUS
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_ADC_TRIM	ADC TRIM
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_DAC_Data_Structures Data Structures
  * @{
  */

/** @defgroup __MDR32F1QI_Periph_DAC_TypeDef DAC_TypeDef
  * @{
  */
...
/** @defgroup __MDR32F1QI_Periph_DAC_Defines Defines
  * @{
  */

/** @defgroup __MDR32F1QI_Periph_DAC_CFG	DAC CFG
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_DAC1_DATA	DAC1 DATA
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_DAC2_DATA	DAC2 DATA
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_PORT_Data_Structures Data Structures
  * @{
  */

/** @defgroup __MDR32F1QI_Periph_PORT_TypeDef PORT_TypeDef
  * @{
  */
...
/** @defgroup __MDR32F1QI_Periph_PORT_Defines Defines
  * @{
  */

/** @defgroup __MDR32F1QI_Periph_PORT_FUNC	PORT FUNC
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_PORT_PULL	PORT PULL
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_PORT_PD	PORT PD
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_PORT_PWR	PORT PWR
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_BKP_REG_0E	BKP REG 0E
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_BKP_REG_0F	BKP REG 0F
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_BKP_RTC_CS	BKP RTC CS
  * @{
  */ 
...
/** @} */ /* End of group __MDR32F1QI_Periph_BKP_Defines */
...
/** @defgroup __MDR32F1QI_Periph_EBC_NAND_CYCLES	EBC NAND CYCLES
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_EBC_CONTROL	EBC CONTROL
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_EBC_RAM_CYCLESx	EBC RAM CYCLESx
  * @{
  */ 
...
/** @} */ /* End of groupe MDR32F1QI_Periph_EBC_Defines Defines */
...
/** @defgroup __MDR32F1QI_Periph_ETH_G_CFGl	ETH G CFGl
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_ETH_G_CFGh	ETH G CFGh
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_ETH_X_CFG	ETH X CFG
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_ETH_R_CFG	ETH R CFG
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_ETH_IMR	ETH IMR
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_ETH_IFR	ETH IFR
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_ETH_STAT	ETH STAT
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_ETH_MDIO_CTRL	ETH MDIO CTRL
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_ETH_PHY_CONTROL	ETH PHY CONTROL
  * @{
  */ 
...
/** @defgroup __MDR32F1QI_Periph_ETH_PHY_STATUS	ETH PHY STATUS
  * @{
  */ 
...
/** @} */ /* End of group __MDR32F1QI_Periph_ETHERNET Defines */

/** @} */ /* End of group __MDR32F1QI_Periph_ETHERNET */
